...
public class RetrofitQuotesConvertSingleton {
    ...
    private RetrofitQuotesConvertSingleton(){

    }

    public static void initQuotesConvert(){
    ...
    public static void resetQuotesConvertCVObservable(String idStr){
    ...
    public static Observable<Map<String, Object>> getQuotesConvertCVObservable(String idStr){
        ...
        if(!previousIdStr.equals(idStr) || observableQuotesCVMetadata == null) {
            resetQuotesConvertCVObservable(idStr);
        }
